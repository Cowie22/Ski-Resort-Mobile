...
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Challenger", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 26, -367, 221, -275, 2);
