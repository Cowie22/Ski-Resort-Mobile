...
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Iron Horse", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 80, -280, 200, -200, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Polaris", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 200, 200, 100, 100, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("The Rapids", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 200, 200, 100, 100, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Burnout", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1810, '20 Minutes', 200, 200, 100, 100, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Monument Glade", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 200, 200, 100, 100, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Rail Splitter", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1810, '20 Minutes', 200, 200, 100, 100, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Sierra Grande", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1810, '20 Minutes', 200, 200, 100, 100, 2);
