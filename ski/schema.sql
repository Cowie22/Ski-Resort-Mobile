...
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("The Camp Glade", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1990, '20 Minutes', 13, -212, 66, -79, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Schwarzstrasse", "Blue Square: More Difficult", 1, 0, 0, 1, 1990, '20 Minutes', 177, -366, 85, -333, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Washoe", "Blue Square: More Difficult", 1, 0, 0, 1, 1990, '20 Minutes', 50, -281, 96, -85, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Lookout Bypass", "Blue Square: More Difficult", 1, 0, 0, 1, 1990, '20 Minutes', 48, -362, 24, -218, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Martis", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1990, '20 Minutes', 73, -298, 138, -83, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Sugar Pine Glade", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1990, '20 Minutes', 102, -316, 169, -70, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Boca", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1990, '20 Minutes', 167, -355, 150, -210, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Gooseneck", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1990, '20 Minutes', 177, -356, 179, -202, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Stampede", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1990, '20 Minutes', 211, -330, 175, -75, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Prosser", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1990, '20 Minutes', 228, -316, 213, -97, 1);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Lookout Glade", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1990, '20 Minutes', 286, -307, 200, -79, 1);

-- Backside Chair

INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Drifter", "Blue Square: More Difficult", 1, 0, 0, 1, 1420, '20 Minutes', -2, -120, 226, -56, 3);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("The Islands", "Blue Square: More Difficult", 1, 0, 0, 0, 1420, '20 Minutes', 5, -157, 200, -69, 3);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Castle Peak", "Blue Square: More Difficult", 1, 0, 0, 1, 1420, '20 Minutes', -3, -192, 206, -73, 3);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Promised Land", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1420, '20 Minutes', 1, -239, 58, -156, 3);
...
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Challenger", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 80, -330, 275, -238, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Follow Me", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 192, -267, 219, -201, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Lower Burnout", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1810, '20 Minutes', 211, -164, 228, -77, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Down Under", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1810, '20 Minutes', 223, -145, 269, -73, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Why Not", "Black Diamond: Most Difficult", 1, 0, 0, 0, 1810, '20 Minutes', 180, -104, 233, -51, 2);
INSERT into runs (name, terrain, status, is_favorite, to_complete, groomed, vertical_feet, wait_time, xStart, yStart, xEnd, yEnd, lift_id) VALUES ("Backdoor", "Black Diamond: Most Difficult", 1, 0, 0, 1, 1810, '20 Minutes', 18, -138, 208, -170, 2);
